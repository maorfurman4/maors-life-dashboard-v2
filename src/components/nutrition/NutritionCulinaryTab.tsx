...
- אם מרכיב לא מפורש כצמחי — אל תכלול אותו`,
    "פליאו": `
חוקי דיאטה פליאו (חובה לעמוד בהם):
- מותר: בשר, עוף, דגים, ביצים, ירקות, פירות, אגוזים, זרעים, שמן זית, שמן קוקוס
- אסור לחלוטין: דגנים (חיטה, אורז, שיבולת שועל), קטניות, מוצרי חלב, סוכר, מזון מעובד`,
    "צום לסירוגין 16:8": `
חוקי צום לסירוגין 16:8 (חובה לעמוד בהם):
- כל הקלוריות היומיות נאכלות בחלון של 8 שעות בלבד (12:00–20:00)
- ארוחה ראשונה: צהריים (לא בוקר) — אל תכלול ארוחת בוקר מוקדמת
- ארוחה אחרונה: לא אחרי 20:00
- מחוץ לחלון: מים, קפה שחור, תה בלבד
- חלק את הקלוריות בין: ארוחת צהריים, ארוחת ערב, וחטיף אחד בלבד`,
    "מאוזנת": `
חוקי דיאטה מאוזנת:
- מגוון מלא: חלבונים, פחמימות מורכבות, שומנים בריאים בפרופורציה טובה
- כולל: ירקות, פירות, דגנים מלאים, חלבון רזה, שמנים צמחיים
