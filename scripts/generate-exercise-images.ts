...
const CHEST: ExerciseEntry[] = [
  ...
  makeEx("Dive Bomber Push-up", "Dive Bomber Floor Exercise", "dive-bomber-push-up-2"),
  ...
  makeEx("Tiger Bend Push-up", "Tiger Bend Floor Strength Move", "tiger-bend-push-up-2"),
...
const BACK: ExerciseEntry[] = [
  ...
  makeEx("Chest Supported Cable Row", "Chest Supported Cable Row"),
