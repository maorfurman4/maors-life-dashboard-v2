...
בנה תוכנית אימונים מחזורית ל-4 שבועות + שבוע Deload. כל אימון: 5-8 תרגילים עם סטים, חזרות, משקל מומלץ (בק"ג), הערות ו-explanation.
    ...
    const res = await fetch("https://api.openai.com/v1/chat/completions", {
      ...
      body: JSON.stringify({
        ...
        tools: [{
          ...
          function: {
            name: "report_plan",
            description: "Report 4-week periodized workout plan with deload week",
            parameters: {
              type: "object",
              properties: {
