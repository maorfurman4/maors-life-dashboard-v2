...
Deno.serve(async (req) => {
  ...
  try {
    ...
    // Fetch push subscriptions — always scoped to the authenticated user (user.id from JWT),
    // never trusting a userId from the request body to prevent cross-user push injection.
